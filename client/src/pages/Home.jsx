...
const Home = () => {
  ...
  return (
    ...
    <div className='flex space-x-6 sm:space-x-12 md:space-x-8'>
      <div className='min-w-[250px] max-h-[280px] sm:max-h-[320px] rounded-lg shadow-lg shadow-black text-blue relative p-6 z-10 border border-blue mt-[30px]' >
      ...
      <div className='min-w-[250px] max-h-[280px] rounded-lg shadow-lg shadow-black text-blue relative p-6 z-10 border border-blue mt-[30px]'>
